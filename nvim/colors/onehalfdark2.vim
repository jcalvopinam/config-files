...
let g:colors_name="onehalfdark2"
let colors_name="onehalfdark2"
...
let s:purple      = { "gui": "#deb3eb", "cterm": "235" }
let s:cyan        = { "gui": "#88cbd4", "cterm": "212"  }
let s:white       = { "gui": "#edeff1", "cterm": "241" }

let s:fg          = s:white
let s:bg          = s:black

let s:comment_fg  = { "gui": "#b3b4b6", "cterm": "182" }
let s:gutter_bg   = { "gui": "#282c34", "cterm": "236" }
let s:gutter_fg   = { "gui": "#919baa", "cterm": "247" }
let s:non_text    = { "gui": "#373C45", "cterm": "239" }

let s:cursor_line = { "gui": "#51545b", "cterm": "91" }
let s:color_col   = { "gui": "#484b51", "cterm": "81" }
